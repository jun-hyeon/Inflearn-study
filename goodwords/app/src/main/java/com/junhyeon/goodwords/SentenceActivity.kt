package com.junhyeon.goodwords
...
class SentenceActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var sentenceadapter = ListViewAdapter(sentenceList)
        var listview = findViewById<ListView>(R.id.sentenceListView)
